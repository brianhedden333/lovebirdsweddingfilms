        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <blockquote className="text-xl text-teal-600 italic border-l-4 border-teal-200 pl-6 font-medium">"I cry watching our wedding film—it captured every moment so beautifully. It's like reliving the best day of our lives."</blockquote>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-sans text-gray-900 mb-3 font-medium">Film It</h3>
