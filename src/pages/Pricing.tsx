...
const Pricing = () => {
  const services = [
    ...
    'Coverage from 2 hours (elopement) to 12 hours (full celebration)',
    'Online photo finishing directions and weather contingency - up to two revisions if needed',
    'Online gallery',
    'Print release for personal use',
    'Video content options for before and/or after the ceremony',
    'Expert hair and makeup coordination',
    'Bridal portraits',
    'The last element that tops it all off',
    'One round of editing feedback',
    'Digital delivery and cloud storage'
  ];
  ...
  const nextSteps = [
    ...
    'Post-production editing and delivery of final gallery'
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              <h3 className="text-2xl font-serif text-gray-900 mb-4">Elopement Package</h3>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <img
                ...
                alt="Personal approach to wedding photography"
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-serif text-gray-900 mb-8">Your Journey with Lisa</h3>
              ...
              <div className="mt-8">
                <a
                  href="/#contact"
                  className="bg-teal-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-teal-700 transition-colors duration-200 inline-block"
                >
                  Start Your Journey
                </a>
              </div>
